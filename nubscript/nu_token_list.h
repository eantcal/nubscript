...
public:
    ...
    //! token list
    data_t::iterator begin() noexcept { return data().begin(); }


    //! Returns an iterator referring to the past-the-end
    //! element in the token list
    data_t::iterator end() noexcept { return data().end(); }


    //! Returns a reverse iterator pointing to the last element in the
    //! token list
    data_t::reverse_iterator rbegin() noexcept { return data().rbegin(); }


    //! Returns a reverse iterator pointing to the theoretical element
    //! preceding the first element in the token list
    data_t::reverse_iterator rend() noexcept { return data().rend(); }


    //! Returns a const_iterator pointing to the first element in the
    //! token list
    data_t::const_iterator cbegin() const noexcept { return data().cbegin(); }


    //! Returns a const_iterator pointing to the past-the-end
    //! element in the token list
    data_t::const_iterator cend() const noexcept { return data().cend(); }
    ...
    size_t iterator_to_pos(data_t::iterator i) { return i - begin(); }
