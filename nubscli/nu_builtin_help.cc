...
static help_content_t _help_content[] = {
    ...
    { lang_item_t::FUNCTION, NUBSCRIPT_OP_INC, "Increment unary operator",
        "++variable" },

    { lang_item_t::FUNCTION, NUBSCRIPT_OP_DEC, "Decrement unary operator",
        "--variable" },
    ...
    { lang_item_t::FUNCTION, "ver$", "Returns language version", "Ver$()" },
    ...
    { lang_item_t::INSTRUCTION, "open",
        ...
        "  Read\n  Write\n  Read Write\n"
        "\nSee also FOpen, Close, FileInput, Write, "
    ...
    { lang_item_t::INSTRUCTION, "fopen",
        ...
        "  The file is created if it does not exist.\n"
        "\nSee also Open, Close, FileInput, Write, "
        "Seek, FTell, FError, Errno, Errno$",
    ...
    { lang_item_t::INSTRUCTION, "struct",
        "A structure in language is a composite data type\n"
